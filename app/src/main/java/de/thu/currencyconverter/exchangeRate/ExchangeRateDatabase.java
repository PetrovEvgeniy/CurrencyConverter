...
public class ExchangeRateDatabase {
    // Exchange rates to EURO - price for 1 Euro
     protected final static ExchangeRate[] RATES = {
            new ExchangeRate("EUR", "Bruxelles", 1.0),
            new ExchangeRate("USD", "Washington DC", 1.0845),
    ...
    synchronized public String[] getCurrencies() {
    ...
    synchronized public String getCapital(String currency) {
     ...
     */
    synchronized public double convert(double value, String currencyFrom, String currencyTo) {
